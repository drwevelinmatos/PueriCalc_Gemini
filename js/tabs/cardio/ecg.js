    ...
    slot.innerHTML = `
        ...
        <div id="ecg_resultado_container" style="display: none; margin-top: 24px; display: flex; flex-direction: column; align-items: center;">
            ...
            <div id="ecg-print-area" style="display: flex; flex-direction: column; justify-content: space-between; background: white; border: 1px solid #cbd5e1; border-radius: 4px; width: 148mm; height: 210mm; position: relative; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1); font-family: 'Arial', sans-serif; color: #000; line-height: 1.5; box-sizing: border-box; overflow: hidden;">
                ...
                <div style="flex-grow: 1; position: absolute; padding: 5mm 10mm 50mm 10mm; z-index: 10; font-size: 12px; box-sizing: border-box;">
                ...
                <div style="position:absolute; width: 100%; line-height: 0; margin-bottom: 0;">
                    <img src="./assets/rodape-a5.png" style="width: 100%; height: auto; display: block; margin-bottom: 0;">
                </div>
            </div>
...
function ecgSintetizarLaudo() {
    ...
    a5Content.innerHTML = `
        ...
        <p style="margin: 0 0 1px 0;">Nome: ${nome}</p>
        <p style="margin: 0 0 1px 0;">Idade: ${anos} anos, ${meses} meses e ${dias} dias</p>
        <p style="margin: 0 0 1px 0;">Sexo: ${sexo}</p>
        <p style="margin: 0 0 1px 0;">Peso: ${peso} kg &nbsp;|&nbsp; Altura: ${altura} cm</p>
